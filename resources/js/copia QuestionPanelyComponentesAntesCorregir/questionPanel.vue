<template>
    ...
    <form @submit.prevent="handleSubmit">
            ...
            <div class="mb-3 row">
                ...
                <div class="sm-5">
                    <input type="text" name="activity_name"
                        ...
                        value="" placeholder="Nombre Actividad">
                </div>
            </div>
        ...
        <div v-for="(item, index) in formList" :key="index">
            <!-- <component :is="item" @update="updateValue" v-mode="bool_statement"></component> -->
            <component :is="item" :key="index" :id="`form_${index}`" @update="updateValue(index, $event)"></component>
        </div>
...
const handleSubmit = () => {
    console.log('Datos a enviar:', formList.value);
