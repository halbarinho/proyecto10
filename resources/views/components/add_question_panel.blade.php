        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full px-4 md:w-1/2 xl:w-1/3">
                <div
                    ...
                    {{-- < type="button" id="type_multiple" --}}
                    {{-- class="p-3 px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700"> --}}
                    <svg id="type_multiple" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="200"
            ...
            <div class="w-full px-4 md:w-1/2 xl:w-1/3">
                <div
                    class="mb-10 overflow-hidden duration-300 bg-white rounded-lg dark:bg-dark-2 shadow-1 hover:shadow-3 dark:shadow-card dark:hover:shadow-3">
                    {{-- <button type="button" id="type_short"
                        class="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700"> --}}
                    <svg id="type_short" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="200"
