    ...
    <main>
        <div class="container py-4">
            ...
            <form action="{{ route('classroom.store') }}" method="post">
                ...
                {{--
                <div class="mb-3 row">
                    <label for="class_name" class="mb-3 block text-base font-medium text-[#07074D]">Nivel Educativo</label>
                    <div class="sm-5">
                        <input type="text" name="stage"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            value="{{ old('') }}" placeholder="Nombre" required>
                    </div>
                </div> --}}
                ...
                {{-- <div class="mb-3 row">
                    ...
                    <div class="sm-5">
                        <select name="stage_id" id="stage_id" class="form-select">
                            ...
                            @if ($stages->isEmpty())
                                <option value="">No Existen Niveles</option>
                            @else
