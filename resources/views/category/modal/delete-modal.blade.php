<div id="dialog-{{ $category->id }}"
    ...
    <div class="w-1/4 p-8 mx-auto my-20 bg-white rounded shadow-md">
        <div class="flex items-center gap-5">
            ...
            <div>
                <h1 class="mb-2 text-lg font-bold">Borrar Categoría</h1>
                <p>¿Está seguro de eliminar definitivamente la categoría?<br> Se perderán los datos.</p>
            </div>
        </div>
        <div class="flex justify-end gap-4 mt-5">

            <button class="px-6 py-2 text-black bg-gray-100 border border-gray-300 rounded hover:bg-gray-200"
                onclick="hideDialog({{ $category->id }})">Cancel</button>
