...
<body class="flex items-center justify-center h-screen overflow-auto bg-gray-50">

    <!-- This is an example component -->
    <div>
        <nav class="fixed top-0 left-0 z-10 w-full bg-white border-b border-gray-200">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <a href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
                            <img src="https://img.icons8.com/glyph-neue/64/darth-vader.png" class="h-6 mr-2"
                                alt="Windster Logo">
                            <span class="self-center whitespace-nowrap">App Vader</span>
                        </a>
        ...
        <div class="flex pt-20 bg-white">
            <aside id="sidebar"
                class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full pt-20 duration-75 lg:flex transition-width"
                aria-label="Sidebar">
                        ...
                        <div class="flex-1 px-3 space-y-1 bg-white divide-y">
                            <ul class="pb-2 space-y-2">
                                ...
                                <li>
                                    <a href="#"
                                        ...
                                        <span class="flex-1 ml-3 whitespace-nowrap">Alertas</span>
                                    </a>
                                </li>
                            </ul>
                            <div class="pt-2 space-y-2">
                                <a href="#"
                                    ...
                                    <span class="ml-4">Problemas Técnicos</span>
                                </a>
                                <a href="#" target="_blank"
                                    class="flex items-center p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group">
                                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
            ...
            <div id="main-content" class="relative w-full h-screen pt-8 bg-gray-50 lg:ml-64">
                <main class="w-">
                    <div class="px-4 pt-6">
                        <div class="grid w-full grid-cols-1 gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                            <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 2xl:col-span-2">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div
                                        class="flex items-center justify-end flex-1 text-base font-bold text-green-500">
                                        12.5%
                            ...
                            <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 ">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="#"
                                            class="p-2 text-sm font-medium rounded-lg text-cyan-600 hover:bg-gray-100">View
                                            all</a>
                                    </div>
                                </div>
                        ...
                        <div class="grid w-full grid-cols-1 gap-4 mt-4 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <div
                                        class="flex items-center justify-end flex-1 w-0 ml-5 text-base font-bold text-red-500">
                                        -2.7%
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                        ...
                        <div class="grid grid-cols-1 my-4 2xl:grid-cols-2 xl:gap-4">
                            ...
                            <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 ">
                                <h3 class="mb-10 text-xl font-bold leading-none text-gray-900">Acquisition Overview
                                </h3>
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="relative w-full">
                                                            <div class="w-full h-2 bg-gray-200 rounded-sm">
                                                                <div class="h-2 rounded-sm bg-cyan-600"
                                                                    style="width: 30%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <footer
                    class="p-4 mx-4 my-6 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8">
                    <ul class="flex flex-wrap items-center mb-6 md:mb-0">
                        ...
                        <li><a href="#"
                                class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6">Licensing</a>
                        </li>
