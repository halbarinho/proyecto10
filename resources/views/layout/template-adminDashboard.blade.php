...
<body class="flex flex-col flex-auto flex-shrink-0 min-h-screen antialiased bg-gray-50">
    ...
    <!-- navbar -->
    <div class="fixed z-10 flex items-center justify-between w-full shadow-md bg-yellowPersonal h-14 shadow-black/5">
        <div
    ...
    <div
        ...
        <div class="flex flex-col justify-between overflow-x-hidden overflow-y-auto">
            <a href="#" class="flex items-center px-4 pt-4 pb-4 border-b border-b-gray-800">
                ...
                <img class="w-8 h-8 mx-auto md:hidden max-w-8 max-h-8 hover:rotate-6"
                    src="{{ asset('icons/logo.png') }}" alt="logo Diketive">


            </a>
            <ul class="mt-4">
                <span class="hidden pl-2 font-bold text-gray-400 md:inline">PANEL ADMINISTRATIVO</span>
                <li class="mb-1">
