    ...
    <div class="mr-4 overflow-auto ml-14 mt-14">
        ...
        {{-- <form action="{{ route('user.updateProfilePhoto', ['user' => $user->id]) }}" method="post"
            ...
            <div class="flex justify-center mt-5">
                ...
                <a href="#" class="mx-3 text-blueLighterPersonal hover:text-blueDarkPersonal">Formulario Contacto</a>
        ...
        {{-- </div>
            ...
            <a href="{{ route('welcome') }}"
                class="px-4 py-2 font-bold text-white rounded-md cursor-pointer bg-rose-500 hover:bg-rose-700">Cancelar</a>
        ...
        <div class="my-6">
            <div
                ...
                {{-- <div>
                      ...
                      <p class="mt-3 text-sm text-gray-400">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                      <div class="mt-12">
                ...
                <div>
                    <form action="{{ route('user.updateProfilePhoto', ['user' => $user->id]) }}" method="post"
                        ...
                        <div class="flex justify-center mt-5">
                            <a href="{{ route('forgetPassword') }}"
                                class="mx-3 text-blueLighterPersonal hover:text-blueDarkPersonal">Cambio Password</a>
                            {{-- <a href="#" class="mx-3 text-blueLighterPersonal hover:text-blueDarkPersonal">Formulario
                                Contacto</a> --}}
                            {{-- <a href="#" class="mx-3 text-blue-500 hover:text-blue-700">GitHub</a> --}}
                        </div>
                        <div class="mt-5 text-center">
