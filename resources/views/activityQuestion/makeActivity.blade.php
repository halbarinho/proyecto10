    ...
    <main>
        <div class="container py-4 mx-auto">
            ...
            <form action="{{ route('activity.sendAnswer') }}" method="POST">
                ...
                <div
                    class="flex items-center justify-end gap-1 p-4 border-t border-gray-200 rounded-b md:p-5 dark:border-gray-600">
                    ...
                    <button
                        ...
                        type="submit" name="status" value="completed">Completar y Enviar</button>
                </div>
