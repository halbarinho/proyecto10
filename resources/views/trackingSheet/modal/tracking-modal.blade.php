    ...
    <div class="relative justify-center w-full max-w-2xl max-h-full p-4 mx-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button" onclick="hideTrackingSheet()"
            ...
            <div class="p-4 space-y-4 md:p-5">
                ...
                <form action="{{ route('trackingSheet.update') }}" method="POST" id="updateForm">
                    @csrf
                    @method('PUT')
                    <input type="hidden" id="trackingSheetId" name="trackingSheetId" value="">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="observations" name="observations" rows="8" required minlength="15"
                    ...
                    <div class="flex items-center p-4 border-t border-gray-200 rounded-b md:p-5 dark:border-gray-600">
                        ...
                        <button data-modal-hide="static-modal" type="button" onclick="hideTrackingSheet()"
