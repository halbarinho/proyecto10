                                            ...
                                            <form action="{{ route('activity.deleteActivities') }}" method="POST"
                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        ...
                                                        onclick="handleSubmit(event); event.preventDefault();">Eliminar
                                                        ...
                                                        <td class="">
                                                            <a href=""
                                                                class="" ">Enviar</a>
                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    {{-- Eliminar --}}
                                                                                                                                                                                                                                                                                                                                                                    <td>
                                                                                                                                                                                                                                                                                                                                                                    <button type="button" id="delete-{{ $activity->id }}" class="w-9 h-9" onclick="showDialog({{ $activity->id }}); event.preventDefault();">
                                                                                                                                                                                                                                                                                                                                                                    <svg version="1.1" width="36" height="36" viewBox="0 0 36 36" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"
                                                                                                                                                                                                                                                                                                                                                                    xmlns:xlink="http://www.w3.org/1999/xlink"> <title>trash-line</title>
                                                                                                                                                                                                                                                                                                                                                                    <path class="clr-i-outline clr-i-outline-path-1" d="
