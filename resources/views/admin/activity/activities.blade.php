                                                                ...
                                                                <td class="max-w-9 max-h-9">
                                                                    <button type="button" id="delete-{{ $activity->id }}"
                                                                        ...
                                                                        <svg version="1.1" width="36" height="36"
                                                                            ...
                                                                            <rect class="clr-i-outline clr-i-outline-path-3"
                                                                                x="21" y="13" width="2" height="15">
                                                                            </rect>
                                                                            <rect class="clr-i-outline clr-i-outline-path-4"
                                                                                x="13" y="13" width="2" height="15">
                                                                            </rect>
