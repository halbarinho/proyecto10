<div id="dialog"
    ...
    data-id="" onclick="hideDialog(); event.preventDefault();">
    <div class="w-1/4 p-8 mx-auto my-20 bg-white rounded shadow-md">
        <div class="flex items-center gap-5">
            ...
            <div>
                ...
                <p>¿Está seguro de eliminar definitivamente la actividad?<br> Se perderán los
                    datos.
                </p>
            </div>
        </div>
        <div class="flex justify-end gap-4 mt-5">
            ...
            <button class="px-4 py-2 font-bold text-white bg-red-500 border border-red-700 rounded hover:bg-red-700"
                onclick="deleteActivity();event.preventDefault();">Eliminar</button>
        </div>
    </div>
</div>
